...
{
    public class SysDictionaryConfig : IEntityTypeConfiguration<SysDictionary>
    {
        public void Configure(EntityTypeBuilder<SysDictionary> builder)
        {
            ...
            //设置表主键
            builder.HasKey(e => e.DictionaryId);
            //设置主键自增
            builder.Property(e => e.DictionaryId)
                   .UseIdentityColumn();
            builder.Property(e => e.Dictionary).IsRequired(false).HasColumnType("jsonb");
